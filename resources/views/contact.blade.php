...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('css/animate.cs')}}s">
        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.html" class="logo">Nursano Gandung Praseto</a></h1>
              <ul>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="colorlib-navbar-brand">
                <a class="colorlib-logo" href="index.html"><span class="logo-img" style="background-image: url( {{ url('images/dung2.jpg')}} );"></span>Nursano Gandung Praseto</a>
              </div>
      ...
      <section class="ftco-section contact-section">
        <div class="container mt-5">
          <div class="row d-flex mb-5 contact-info">
            ...
            <div class="w-100"></div>
            <div class="col-md-3">
              <p><span>Address:</span> Dasana Indah blog UE 4/14 Kab. Tangerang</p>
            </div>
            <div class="col-md-3">
              <p><span>Phone:</span> <a href="tel://1234567920">+62 831 7060 9165</a></p>
            </div>
            <div class="col-md-4">
              <p><span>Email:</span> <a href="mailto:nursanogandung@yahoo.co.id">nursanogandung@yahoo.co.id</a></p>
            </div>
            <!--
            <div class="col-md-3">
