          ...
          <div class="row">
            <div class="col-md-12">
              <div class="colorlib-navbar-brand">
                <a class="colorlib-logo" href="index.html"><span class="logo-img" style="background-image: url( {{ url('images/person_1.jpg')}} );"></span>Beckham Muff</a>
              </div>
        ...
        <div class="container mt-5">
          ...
          <div class="row d-flex justify-content-center">
            <div class="col-md-8">
              ...
              <p>
                <img src="{{ url('images/image_6.jpg') }}" alt="" class="img-fluid">
              </p>
              ...
              <p>
                <img src="{{ url('images/image_8.jpg')}}" alt="" class="img-fluid">
              </p>
