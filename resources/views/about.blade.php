        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              ...
              <ul>
                <li><a href="{{ url('index') }}"><span><small>01</small>Home</span></a></li>
                <li><a href="{{ url('about') }}"><span><small>02</small>Resume</span></a></li>
                <li><a href="{{ url('service') }}"><span><small>03</small>Services</span></a></li>
                <li><a href="{{ url('portfolio') }}"><span><small>04</small>Portfolio</span></a></li>
                <li><a href="{{ url('blog') }}"><span><small>05</small>Blog</span></a></li>
                <li class="active"><a href="{{ url('contact') }}"><span><small>06</small>Contact</span></a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section class="ftco-section about-section">
        <div class="container">
          <div class="row d-flex my-5" data-scrollax-parent="true">
            <div class="col-md-4 author-img" style="background-image: url( {{ url('images/dungTegal.jpg')}} );"></div>
          ...
          <div class="row d-flex justify-content-end mt-5">
          	<div class="col-md-10">
          		<div class="profile ftco-animate">
	          		...
	          		<h4 class="mb-4">I'm an Informatic Engineering collage student from Institute Technology of Sumatera. I aim to make a difference through my creative solution.</h4>
	          		<p>I interest in developing a website and mobile app. Beside I do code, i also can make my own design and it would have so much fun for me. I can do both code and design and make me enjoy my jobs.</p>
	          		<div class="row my-5">
		          		<div class="col-md-12">
		          			<p><strong>Name :</strong> <span>Nursano Gandung Praseto</span></p>
                    <p><strong>Address :</strong> <span>Dasana Indah Blok UE 4 No. 14, Kabupaten Tangerang, Indonesia</span></p>
		          			<p><strong>Phone :</strong> <span>(+62) 831 7060 9165</span></p>
                    <p><strong>Status :</strong> <span>Single</span></p>
		          		</div>
	          		</div>
          		</div>
          		...
          		<div class="exp mt-5 ftco-animate">
          			...
          			<div class="exp-wrap py-4">
          				<div class="desc">
	          				<h4>Gudang Bidan app</h4>
	          				<p>An app that could manage medical patient of midwifery.</p>
          				</div>
          				<div class="year">
          					<p>2019</p>
          				</div>
